...
// JWT Authentication
var jwtKey = builder.Configuration["Jwt:Key"] ?? "UrunSatisPortali_Super_Secret_Key_1234567890!";
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Urun Satis Portali API", Version = "v1" });
